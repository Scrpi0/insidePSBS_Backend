...
Pour ce projet, il est nécessaire d'avoir installé les logiciels/services suivants :
...
php artisan serve
```
ou pour forcer l'ouverture des sockets IPv4 sur les réseaux du serveur :
